...
const Hero = () => {
  return (
    <div>
      ...
      <div className='lg:w-1/2 lg:mx-auto lg:my-32 my-20 sm:mx-4 md:mx-4 text-center'>
        <h1 className='heading lg:text-6xl text-3xl'>The Maiden Edition of Game Festival by Gameverse Africa</h1>
        ...
        <div className='flex justify-evenly bg-white rounded-md p-2 text-black text-left w-72 mx-auto'>
          ...
          <div className='ml-4'>
            <p className='text-xs'>16th - 21st October 2023.</p>
